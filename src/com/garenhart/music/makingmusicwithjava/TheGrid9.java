...
// Play back with sample-based instruments

public class TheGrid9 implements JMC, ItemListener, ActionListener {
    ...
    private GridMusic9 musicObject;
    ...
    */
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == saveBtn) {            
            musicObject.saveFile("DrumPattern9.mid");
        }
        if(e.getSource() == audioSavebtn) {            
            musicObject.saveAudioFile("DrumPattern9.au");
        } 
        if(e.getSource() == sampleSaveBtn) {            
            musicObject.saveSampleFile("DrumSamplePattern9.au");
        } 
