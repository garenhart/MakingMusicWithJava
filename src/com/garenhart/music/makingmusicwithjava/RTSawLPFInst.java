...
public final class RTSawLPFInst extends Instrument{
	//----------------------------------------------
	// Attributes
	//----------------------------------------------
    ...
    */
     public RTSawLPFInst(int sampleRate, int filterCutoff, int channels){
	...
	public void createChain(){
        ...
        Envelope env = new Envelope(filt, 
             new double[] {0.0, 0.0, 0.1, 1.0, 0.2, 0.5, 0.8, 0.3, 1.0, 0.0});
